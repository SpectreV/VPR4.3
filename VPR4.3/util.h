...
void ****alloc_matrix4(int nrmin, int nrmax, int ncmin, int ncmax, int ndmin,
		int ndmax, int nnmin, int nnmax, size_t elsize);

void free_matrix4(void *vptr, int nrmin, int nrmax, int ncmin, int ncmax, int ndmin,
		int ndmax, int nnmin, size_t elsize);
